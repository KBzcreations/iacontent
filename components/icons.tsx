...
export const UsersIcon: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M18 18.72a9.094 9.094 0 003.741-.479 3 3 0 00-4.682-2.72m-7.5-2.962a3.75 3.75 0 100-7.5 3.75 3.75 0 000 7.5zM3 13.249a9.087 9.087 0 012.29-5.912m15.358 5.912a9.083 9.083 0 01-2.29 5.912m0 0a3.007 3.007 0 01-4.682 2.72 8.982 8.982 0 01-4.244 0 3.007 3.007 0 01-4.682-2.72m6.038-5.855a18.736 18.736 0 00-4.244 0m8.488 0a18.736 18.736 0 00-4.244 0" />
    </svg>
);
